...
public class Node : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public Sprite activeNodeSprite;     // 노드에 마우스 올렸을때 or 구매한 노드일 때
    public Sprite notActiveNodeSprite;  // 구매하지 않은 노드일 때
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        if (canHover)
        {
            nodeImage.sprite = activeNodeSprite;    // 노드 밝은 색으로 변경
        }
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        ...
        {
            nodeImage.sprite = activeNodeSprite;
        }
        else    // 구매 안한 노드이면 노드 어두운 색으로 변경
        {
            nodeImage.sprite = notActiveNodeSprite;
        }
    }
